...
<div id="siteAds">
    ...
    <table class="mark_assignment" width="100%" border=0>
        ...
        <tr>
            <td>
                ...
                <form action="{{ route('educatorMarkAssignment')}}" method="post" class="form-group">
                    ...
                    <input type="number" name="submission_mark" class="assignment_mark_input" value='{{ $a->submission_mark }}' min='1' max='{{$a->assignment_full_mark}}' required> / {{$a->assignment_full_mark}} Marks
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <br>
                <textarea name="assignment_feedback" class="assignment_feedback" cols="23" rows="15" placeholder="Comments on note .... ">{{$a->submission_educator_feedback}}</textarea>
            </td>
        </tr>
        <tr>
            <td>
                <button class="approve_button" name="submit" value="1">
                    <span class="button_text" onclick="return confirm('Are you sure?')">Save Changes</span></a>
                </button>
                <br><br>
            </td>
        </tr>
